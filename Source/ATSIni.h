//
// Generated on 2018/03/31 by inimoni 
//
...
public:                                                                 
    ...
    struct _Index
    {
        int      ConstantSpeedControl;
        int      HoldingSpeedBrake;
    } Index;
...
protected:
    ...
    {                                
        ...
        inimoni::inirw( r,f,s, _T("HoldingSpeedBrake"), Index.HoldingSpeedBrake );
    ...
    void init()                                                         
    {                                                                   
        Index.ConstantSpeedControl   = 213;
        Index.HoldingSpeedBrake      = 214;
        Key.Switch                   = _T("D");
    }                                                                   
};
